...
local getcustomassets = {
	['unreal/assets/wurst/triangle.png'] = 'rbxasset://wurst/triangle.png'
}
...
local function downloadFile(path, func)
	if not isfile(path) then
		local suc, res = pcall(function() return game:HttpGet('https://raw.githubusercontent.com/xwac/Unreal/'..readfile('unreal/profiles/commit.txt')..'/'..select(1, path:gsub('unreal/', '')), true) end)
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		triangle.Image = getcustomasset('unreal/assets/wurst/triangle.png')
